  ...
  if (isDragging) {
    return (
      <div
        ref={setNodeRef}
        style={style}
        className="bg-columnBackgroundColor w-[350px]
        opacity-60 border-2 border-rose-500 h-[500px] max-h-[500px] rounded-md flex flex-col"></div>
    );
  }
  ...
  return (
    <div
      ...
      <div
        ...
        className="bg-mainBackgroundColor text-md h-[60px] cursor-grab 
